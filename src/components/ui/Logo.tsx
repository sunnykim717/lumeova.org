...
const SIZE_MAP: Record<LogoSize, { w: number; h: number; width: number; src: string }> = {
  header: { w: 300, h: 267, width: 300, src: "/logo/logo-horizontal.png" },
  "header-mobile": { w: 200, h: 178, width: 200, src: "/logo/logo-horizontal.png" },
  "brand-mark": { w: 90, h: 80, width: 90, src: "/logo/symbol-gold.png" },
  "brand-story": { w: 290, h: 258, width: 290, src: "/logo/logo-primary.png" },
  footer: { w: 200, h: 178, width: 200, src: "/logo/logo-reverse.png" },
  "footer-mobile": { w: 160, h: 142, width: 160, src: "/logo/logo-reverse.png" },
};
